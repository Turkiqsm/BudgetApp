(function (global, factory) {
    ...
    (factory((global.pose = {}),global.Vue));
    ...
    ***************************************************************************** */
    ...
    var methods = {
        ...
        setPose: function (pose) {
            ...
            this.poser.set(pose).then(function () { return onPoseComplete && onPoseComplete(); });
        },
        ...
        return Vue.extend({
            ...
            mounted: function () {
                ...
                if (!this.$props.withParent || !this._poseRegisterChild) {
                    this.initPoser(domPose$1(this.$el, poserConfig));
                }
                else {
    ...
    var setPoserTo = function (fromPose, toPose, defaultConfig) { return function (el, done) {
        if (!PoserMap.has(el)) {
            PoserMap.set(el, domPose$1(el, __assign({}, defaultConfig, { initialPose: fromPose })));
        }
        PoserMap.get(el)
            .set(toPose)
            .then(done);
